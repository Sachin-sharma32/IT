...
const Header7 = () => {
    ...
    return (
        <div className=" flex flex-col  justify-center items-center p-10 z-40 pb-20 bg-gradient-to-tr from-blue-50 to-blue-100">
            <motion.div
                initial={{ opacity: 0 }}
            ...
            >
                <h2 className=" text-center mb-4 text-3xl font-extrabold tracking-tight text-black">
                    INDUSTRIES WE CATER
                </h2>
                <div className="sm:grid md:grid-cols-2  lg:grid-cols-3 gap-10 px-10 w-screen flex overflow-scroll py-10 header-4">
                    {data.map((item, i) => (
                        <div
                            key={i}
                            className="bg-white shadow-lg rounded-lg p-4 flex flex-col justify-center min-w-[250px] gap-6 items-center hover:text-purple-500 cursor-default hover:scale-110 transition-all duration-500 hover:-translate-y-4 grayscale hover:grayscale-0"
                        >
                            <div>
