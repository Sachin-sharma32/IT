    ...
    return (
        <div>
            ...
            >
                <div
                    ref={containerRef}
                    className=" bg-gradient-to-r from-blue-100 to-green-100 transition-all duration-500 absolute top-14 -right-[300px] bg-white flex flex-col gap-4 p-4 z-50 rounded-lg"
                >
                            ...
                            <Li
                                ...
                                className={`${
                                    active === i
                                        ? "lg:text-purple-700"
                                        : "text-black"
                                } block py-2 pl-3 pr-4  bg-purple-700 rounded lg:bg-transparent hover:text-black transition-all duration-300  lg:p-0 dark:`}
                                aria-current="page"
                                onClick={() => {
                                    handleContainer();
                                    setActive(i);
                ...
                <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                    ...
                    <div
                        className="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1 z-50"
                        id="mobile-menu-2"
                    >
                        {router.pathname === "/" && (
