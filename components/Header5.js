...
const Header5 = ({ yOffset, header5Ref }) => {
    ...
    return (
        <section
            ref={header5Ref}
            className="bg-gray-50 dark:bg-gray-800 z-40 w-full h-[200vh] relative flex justify-center"
            id="testimonials"
        >
            <div
                ref={childRef}
                className=" bg-transparent max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6 top-0 mt-20 h-screen w-screen"
            >
