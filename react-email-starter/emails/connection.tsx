                ...
                <Container style={container}>
                    ...
                    <Section style={paragraphContent}>
                        ...
                        <Text style={paragraph}>
                            ...
                            standards and practices for this policy remain the
                            same.
                        </Text>
                    </Section>
                    <Section style={paragraphList}>
                        <Text style={paragraph}>
                            ...
                            These exceptions include permanently private apps
                            and apps that target automotive or wearables form
                    ...
                    <Section style={paragraphContent}>
                        <Text style={paragraph}>
                            We’re also extending the deadline to give you more
                            time to adjust to these changes. Now, apps that
                            target API level 29 or below will start experiencing
                            reduced distribution starting <b>Jan 31, 2023</b>{" "}
                            instead of Nov 1, 2022. If you need more time to
                            update your app, you can request an extension to
                            keep your app discoverable to all users until May 1,
                            2023.
                        </Text>
                        <Hr style={hr} />
                    </Section>
                    ...
                    <Section style={{ ...paragraphContent, paddingBottom: 30 }}>
                        ...
                        >
                            ...
                            to your Google Play Developer account.
                        </Text>
                    </Section>
                </Container>
            </Body>
