            ...
            <div className="min-h-screen flex flex-col gap-20 pb-20">
                ...
                <div className=" h-fit py-10 flex justify-center items-center px-10">
                    ...
                    >
                        ...
                        <p className="text-lg ">
                            We&apos;re committed to making a positive impact on
                            the environment, society, and governance through our
                ...
                <div className="flex flex-col gap-10">
                    ...
                    <div className="flex gap-10 justify-center flex-col md:flex-row items-center">
                        <div className=" w-[300px] px-4 leading-[1.9] hover:scale-110 py-4 flex flex-col gap-4 h-[550px]  shadow-2xl rounded-lg cursor-default hover:-translate-y-4 transition-all duration-500">
                            <img
                                src="/svg-1.svg"
                                alt=""
                                className="w-[200px] h-[200px] self-center"
                            />
                            At IT Xcelerate, we recognize that climate change is
                            one of the most pressing issues facing the world
                            today. As a technology company, we&apos;re committed
                            to using our expertise and resources to develop
                            innovative solutions that address climate change and
                        ...
                        <div className=" w-[300px] px-4 leading-[1.9] hover:scale-110 py-4 flex flex-col gap-4 h-[550px]  shadow-2xl rounded-lg cursor-default hover:-translate-y-4 transition-all duration-500">
                            ...
                            reduction and recycling programs. We also ensure
                            that our supply chain partners and vendors share our
                    ...
                    <div className="flex gap-10 justify-center flex-col md:flex-row items-center">
                        <div className=" w-[300px] px-4 leading-[1.9] hover:scale-110 py-4 flex flex-col gap-4 h-[550px]  shadow-2xl rounded-lg cursor-default hover:-translate-y-4 transition-all duration-500">
                            <img
                                ...
                                className="w-[200px] h-[200px] self-center"
                            />
                            We believe that every business has a responsibility
                            to contribute to the well-being of society. At IT
                            Xcelerate, we&apos;re committed to promoting
                        ...
                        <div className=" w-[300px] px-4 leading-[1.9] hover:scale-110 py-4 flex flex-col gap-4 h-[550px]  shadow-2xl rounded-lg cursor-default hover:-translate-y-4 transition-all duration-500">
                            ...
                            sustainability. We also encourage our employees to
                            volunteer their time and skills to support community
                            initiatives that align with our values and mission.
                        </div>
                        <div className=" w-[300px] px-4 leading-[1.9] hover:scale-110 py-4 flex flex-col h-[550px] gap-4  shadow-2xl rounded-lg cursor-default hover:-translate-y-4 transition-all duration-500">
                            <img
                                src="/svg-5.svg"
                                alt=""
                                className="w-[200px] h-[200px] self-center"
                            />
                            We ensure that our employees are treated with
                            respect, fairness, and dignity, and we do not
                            tolerate any form of discrimination, harassment, or
                            abuse. Our goal is to create a workplace where every
                            employee feels valued, supported, and empowered to
                ...
                <div className="flex flex-col gap-10">
                    ...
                    <div className="flex gap-10 justify-center flex-col md:flex-row items-center">
                        <div className=" w-[300px] px-4 leading-[1.9] hover:scale-110 py-4 flex flex-col gap-4 h-[550px]  shadow-2xl rounded-lg cursor-default hover:-translate-y-4 transition-all duration-500">
                            ...
                            robust governance framework in place to ensure that
                            we operate in compliance with all relevant laws and
                            regulations.
                        </div>
                        <div className=" w-[300px] px-4 leading-[1.9] hover:scale-110 py-4 flex flex-col gap-4 h-[550px]  shadow-2xl rounded-lg cursor-default hover:-translate-y-4 transition-all duration-500">
                            <img
                                ...
                                className="w-[200px] h-[200px] self-center"
                            />
                            We value the input and feedback of our stakeholders
                            and are committed to maintaining open and
                            transparent communication with them. We regularly
                            assess our governance practices and make
                            improvements as necessary to ensure that we meet the
                        ...
                        <div className=" w-[300px] px-4 leading-[1.9] hover:scale-110 py-4 flex flex-col gap-4 h-[550px]  shadow-2xl rounded-lg cursor-default hover:-translate-y-4 transition-all duration-500">
                            ...
                            we&apos;re continuously looking for ways to improve
                            our environmental, social, and governance practices.
                            We believe that ESG is not just the right thing to
                            do, but it also makes good business sense.
                        </div>
                    </div>
                </div>
            </div>
