                ...
                <div className="flex p-10 gap-10 flex-col md:flex-row">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="leading-[1.9] font-[100] text-xl">
                            ...
                            Xcelerate, we understand the challenges that come
                            with digital transformation and how it can impact
                            businesses of all sizes. Our goal is to help you
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="leading-[1.9] text-lg font-semibold">
                            ...
                            understand your business objectives and work with
                            you to develop a customized strategy that addresses
                            your specific needs. Our team of experts has
                            extensive experience in a variety of industries, and
                            we use this knowledge to create solutions that are
